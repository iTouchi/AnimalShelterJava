...
public class SimpleRestClient {
    ...
    private final String url = "http://localhost:8091/greeting/";
    private final String url2 = "http://localhost:8091/product/";
